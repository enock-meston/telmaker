...
<html lang="en">
<head>
<title>TELMAKER | Official Website</title>
<meta charset="UTF-8" />
        ...
        <div class="navbar navbar-inverse navbar-fixed-top animated fadeInDown" role="navigation" id="top-nav">
          <div class="container">
            <div class="navbar-header">
              <!-- Logo Starts -->
              <a class="navbar-brand" href="#home"><img src="assets/images/logo1.png" height="30" alt="logo"/></a>
              <!-- #Logo Ends -->
...
<div class="row">
	...
	<div class="fronttext">
	 	<h2 class="bgcolor  animated fadeInUpBig"><span class="glyphicon glyphicon-headphones"></span> TELMAKER</h2><br>
...
<div class="row">
    ...
    <div class="album">
      <img src="assets/images/3.jpg" class="img-responsive" alt="music theme" />
...
<div id="footer">
<div class="container">
Copyright <?php $day = date('Y'); echo $day;?> TELMAKER.
</div>
</div>
<!-- # Footer Ends -->
...
<div class="carousel-inner">
    ...
    <div class="item"><img src="assets/images/back1.jpg" alt="" /></div>
    <div class="item"><img src="assets/images/back1.jpg" alt="" /></div>
  </div>
</div>
<!-- background slider -->
